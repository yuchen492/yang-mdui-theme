      ...
      <div class="form-group [type]">
        ...
        <div class="input-group">
          ...
          <div class="input-group-append">
            <img  {if [id]=='[id]'}id="[type][id]"{else}id="[type]"{/if}   width="120px" class="border pointer" alt="点击获取验证码" onClick="getVerify('[type]')">
          </div>
        </div>
      </div>
    {/if}
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <div class="input-group">
          <input {if [id]=='[id]'}id="captcha_[type][id]"{else}id="captcha_[type]"{/if} type="text" name="captcha" class="form-control "  placeholder="请输入验证码" />
          <div class="input-group-append">
            <img {if [id]=='[id]'}id="[type][id]"{else} id="[type]"{/if}  width="120px" class="border pointer" alt="点击获取验证码" onClick="getVerify('[type]','[id]')">
          </div>
        </div>
      </div>
    </div>
