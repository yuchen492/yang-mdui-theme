    ...
    <div class="mdui-col">
        ...
        <div class="mdui-card mdui-p-a-1">
          <div class="mdui-card-primary">
            <div class="mdui-card-primary-title">玲行云端魔方控制台协作云服务</div>
            <div class="mdui-card-primary-subtitle">管理您的魔方控制台协作云实例</div>
          </div>
          <div class="mdui-card-content">
            <p>玲行云端提供第三方合规云业务提供者的对接服务。玲行云端自2023年1月重构协作云架构后，与下述展示出的合作服务商签约，可为玲行云端用户提供低于在原平台购买的价格。</p>
            <p>用户可以在玲行云端中，使用玲行云端账户资产下的余额，购置、开通、管理第三方云服务商的实例。<p>
            <p>使用玲行云端协作云产品的优点：</p>
            <ul>
                <li>在玲行云端协作云新建实例，享受相同的服务，付出更低的价格。</li>
                <li>您无需再注册额外的账户，即可通过玲行云端一站管理多个服务商的实例。</li>
                <li>您可以直接使用玲行云端的账户余额，而无需额外充值到其他服务商。</li>
                <li>提供和大多数对接云更好的使用体验。玲行云端可帮助您完成实例维护。</li>
            </ul>
            <p>玲行云端协作云实例相关协议可能与现行玲行云端用户协议相比有额外补充款项。请参阅玲行云端中文站文档中心“用户协议”一栏。</p>
            <p>此处列举仅包括第三方同为使用智简魔方的云服务商。对于更多协作云产品，请参阅其他用户中心，或询运营团队获取帮助。</p>
          </div>
          <div class="mdui-card-actions mdui-card-actions-stacked">
            <a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-blue-a400" href="https://www.incloudify.com/zhcn/docs/agreement/service-agreement/"><i class="mdui-icon material-icons">view_list</i> 帮助文档</a>
          </div>
        </div>
...
<div class="mdui-row">
    <div class="mdui-col">
        ...
        <div class="mdui-card mdui-p-a-1">
          <div class="mdui-card-primary">
            <div class="mdui-card-primary-title">协作云服务商一览</div>
          </div>
          <div class="mdui-card-content">
              
              <p>协作云动态变更较快，请参阅玲行云端官方网站的公示信息。</p>
